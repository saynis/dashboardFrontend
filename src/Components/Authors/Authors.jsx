...
const Authors = ({authors: authorsList, refreshAuthors}) => {
  ...
  const handleDelete = async (id) => {
    const {data} = await axios.delete(`${import.meta.env.VITE_API_URL}/api/authors/delete/${id}`)
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    const {data} = await axios.put(`${import.meta.env.VITE_API_URL}/api/authors/update/${updateId}`, formValues)
...
const handleSubmit = async (e) => {
  ...
  const {data} = await axios.post(`${import.meta.env.VITE_API_URL}/api/authors/new`, formValues)
